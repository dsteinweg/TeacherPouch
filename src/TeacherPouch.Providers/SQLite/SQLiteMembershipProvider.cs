...
namespace TeacherPouch.Providers.SQLite
{
    /// <summary>
    ...
    public sealed class SQLiteMembershipProvider : MembershipProvider
    {
        ...
        private string EncodePassword(string password, MembershipPasswordFormat passwordFormat, string salt)
        {
            ...
            Buffer.BlockCopy(passwordBytes, 0, dst, saltBytes.Length, passwordBytes.Length);
            ...
            switch (passwordFormat)
            {
                ...
                case MembershipPasswordFormat.Hashed:
                    ...
                    if (algorithm is HMACSHA256)
                    {
                        var hmacsha256 = algorithm as HMACSHA256;

                        hmacsha256.Key = saltBytes;
                        inArray = hmacsha256.ComputeHash(passwordBytes);
                    }
                    else
                    {
